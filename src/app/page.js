...
export default function Home() {
  return (
    <main className="overflow-x-hidden no-scrollbar bg-white pt-20">
      ...
      <section
        className="w-full overflow-hidden bg-[#eef7ff]"
        data-aos="fade-left"
      ...
      >
        {/*
    IMPORTANT:
    This div is the coordinate system for BOTH:
    1. Banner
    2. Cards

    So when banner grows, cards grow/move with it.
  */}
