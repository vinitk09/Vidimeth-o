          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2.5 -mt-1">
              {[
                ...
                { type: "instagram", href: "https://www.instagram.com/vidimeth", label: "Instagram" },
              ].map((item) => (
                <a
                  key={item.type}
                  href={item.href}
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/10 text-white shadow-md border border-white/15 transition-all duration-300 hover:bg-[#0077c8] hover:border-[#0077c8] hover:scale-110 focus:outline-none"
