      ...
      <section className="px-5 py-12 sm:px-8 lg:px-10">
        <div className="mx-auto w-full max-w-4xl text-[#333]">
          ...
          <div className="prose prose-slate max-w-none text-[15px] leading-[1.75]">
            <h2 className="text-[24px] font-semibold text-[#0a1f44] mb-4">Privacy Policy</h2>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Collection of Information</h3>
            <p className="mb-4">
            ...
            <h4 className="text-[17px] font-semibold text-[#0a1f44] mt-6 mb-2">Personal Information :</h4>
            <p className="mb-3">
            ...
            <h4 className="text-[17px] font-semibold text-[#0a1f44] mt-6 mb-2">Non-Personal Information :</h4>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Use of Information</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Sharing and Disclosure</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Links to Third Party Websites</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Security Precautions</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">User Discretion and Opt-Out</h3>
            <p className="mb-4">
            ...
            <div className="my-8 bg-[#fbfbfb] p-6 sm:p-8 rounded-lg border border-slate-200 shadow-sm">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-10 mb-3">Advertisements</h3>
            <p className="mb-10">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">EMAIL & SMS Communications from us and Our Partners</h3>
            <p className="mb-10">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Social Media</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Changes to this Privacy Policy</h3>
            <p className="mb-10">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Disclaimer</h3>
            <p className="mb-10">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Your Consent</h3>
            <p className="mb-10">
            ...
            <h3 className="text-[20px] font-semibold text-[#0a1f44] mt-8 mb-3">Further Acknowledgements</h3>
