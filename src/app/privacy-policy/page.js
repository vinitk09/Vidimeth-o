  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] pt-20">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(to bottom, rgba(0, 0, 0, 0.70), rgba(0, 0, 0, 0.82)), url('https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=2000&q=80')",
        }}
      >
        ...
        <div className="relative mx-auto w-full max-w-7xl" data-aos="fade-up">
          ...
          {/* <p className="mx-auto mt-3 max-w-2xl text-sm font-normal text-slate-300 sm:text-base">
            How Vidi Meth Digital Services collects, protects, and handles your personal data.
          </p> */}
        </div>
      </section>
          ...
          <aside className="hidden lg:block sticky top-24 self-start z-20">
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-[0_12px_36px_rgba(10,31,68,0.06)]">
              ...
              <nav className="space-y-1 text-xs font-medium text-slate-600">
                <a href="#overview" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Policy Overview</a>
                <a href="#collection" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Collection of Information</a>
                <a href="#use" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Use of Information</a>
                <a href="#sharing" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Sharing & Disclosure</a>
                <a href="#third-party" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Third Party Links</a>
                <a href="#security" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Security Precautions</a>
                <a href="#opt-out" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">User Opt-Out Form</a>
                <a href="#social" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Social Media Policy</a>
                <a href="#grievance" className="block rounded-lg px-3 py-2 transition-all hover:bg-slate-100 hover:text-[#0077c8]">Grievance Officer</a>
              </nav>
            </div>
          </aside>
